        ...
        <div class="row mb-2">
          <div class="col-sm-6 col-md-2">
           ...
           <div class=" card-footer">
            <a class="btn btn-block btn-primary " href="index.php"> Adicionar Pizza</a>
           </div>        
          </div><!-- /.col -->
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pesquise por todas as pizzas cadastradas</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  if ($result->num_rows >= 0) {
                    while ($row = $result->fetch_array()) {
                      ...
                      <tr>
                        ...
                        <td>". $row['tipo']."</td>
                        <td>". $row['status']."</td>
                        <td><a href='editarpizza.php?id=".$row['id']."'> <i class='nav-icon fas fa-edit'></i></a></td>
                      </tr>

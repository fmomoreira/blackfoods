          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">EDITAR ESFIHA</h3>
             
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="editaresfiha">
                <div class="card-body">
                  <div class="row">
                  ...
                  if ($result->num_rows >= 0) {
                    while ($row = $result->fetch_array()) {
                      ...
                      <label id='tituloedit'>Status Cardapio</label>
                      ...
                      <div class='form-group col-sm-12 col-md-4'>
                        <label id='tituloedit' for='codesfiha'>Código ESFIHA</label>
                        <input type='number' class='form-control' id='codesfiha' name='codesfiha' value='". $row['codigo_pizza'] ."' required>
                    </div>
               
                    <div class='form-group col-sm-12 col-md-4'>
                      <label id='tituloedit'>TIPO ESFIHA</label>
                  ...
                  <div class='form-group col-sm-12 col-md-6'>
                    <label id='tituloedit'>PREÇO ESFIHA promocional?</label>
                  ...
                  <div class='form-group col-sm-12 col-md-6'>
                    <label id='tituloedit' for='precoesfiha'>Preço Esfiha</label>
                    <input  type='text' class='form-control' id='precoesfiha' name='precoesfiha'  value='". $row['precopizza'] ."' required></input>
                  </div>
             
                    
                  <div class='form-group col-sm-12 col-md-6'>
                    <label id='tituloedit' for='nomeesfiha'>Digite o nome da ESFIHA que quer adicionar?</label>
                    <input type='text' class='form-control' id='nomeesfiha' name='nomeesfiha' value='". $row['nomepizza'] ."' required>
                  </div>
               
                    <div class='form-group col-sm-12 col-md-6'>
                     <label id='tituloedit' for='ingredientespizza'>Quais ingredientes compoem essa nova receita?</label>
...
<script src="src/js/ajax/editsfiha.js"></script>
